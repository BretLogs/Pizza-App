...
import 'package:pizza_app/blocs/sign_up_bloc/sign_up_bloc.dart';
                      ...
                      Expanded(
                        ...
                        children: <Widget>[
                          BlocProvider<SignInBloc>(
                            create: (BuildContext context) => SignInBloc(context.read<AuthenticationBloc>().userRepository),
                            child: const SignInScreen(),
                          ),
                          BlocProvider<SignUpBloc>(
                            create: (BuildContext context) => SignUpBloc(context.read<AuthenticationBloc>().userRepository),
